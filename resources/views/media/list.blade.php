        ...
        <div class="box box-primary">
            ...
            <div class="box-body no-padding">
                ...
                <div class="mailbox-controls with-border">
                    ...
                    <div class="btn-group">
                        <a href="{{ route('dcat.admin.media.index', ['path' => $url['path'], 'view' => 'table']) }}" class="btn btn-default {{ request('view') == 'table' ? 'active' : '' }}"><i class="fa fa-list"></i></a>
                        <a href="{{ route('dcat.admin.media.index', ['path' => $url['path'], 'view' => 'list']) }}" class="btn btn-default {{ request('view') == 'list' ? 'active' : '' }}"><i class="fa fa-th"></i></a>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="moveModalLabel">{{ trans('media.fields.rename') }} & {{ trans('media.fields.move') }}</h4>
            ...
            <form id="file-move">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="recipient-name" class="control-label">{{ trans('media.fields.path') }}:</label>
                        <input type="text" class="form-control" name="new" />
                    </div>
                    <input type="hidden" name="path"/>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">{{ trans('media.fields.close') }}</button>
                    <button type="submit" class="btn btn-primary btn-sm">{{ trans('media.fields.submit') }}</button>
                </div>
            </form>
        </div>
    </div>
