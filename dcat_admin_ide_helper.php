...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection diyname
     ...
     * @method Grid\Column|Collection diyname(string $label = null)
     ...
     * @property Show\Field|Collection diyname
     ...
     * @method Show\Field|Collection diyname(string $label = null)
